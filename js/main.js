...
let mainColorsDark = localStorage.getItem("color_option_bg");

if (mainColorsDark !== null) {
    document.documentElement.style.setProperty('color_option_bg', mainColorsDark);
}
/*##########################################################################*/
/*##########################################################################*/
...
colorsdark.forEach(li => {
    li.addEventListener("click", (element) => {
        ...
        //save color in local storage
        localStorage.setItem("color_option_dark", element.target.dataset.dark);
        //remove active class in list
        element.target.parentElement.querySelectorAll(".active").forEach(ele => {
            ele.classList.remove('active');
        });
        element.target.classList.add('active');
        document.querySelector(".contact .overlay").style.position = "relative"
    });
